...
namespace wick
{
	enum WickKey
    {
        ...
        W_LEFT = 263, W_DOWN = 264, W_UP = 265, W_PAGE_UP = 266,
        W_PAGE_DOWN = 267, W_HOME = 268, W_END = 269, W_CAPS_LOCK = 280,
        W_SCROLL_LOCK = 281, W_NUM_LOCK = 282, W_PRINT_SCREEN = 283,
        W_PAUSE = 284, W_F1 = 290, W_F2 = 291, W_F3 = 292, W_F4 = 293,
        W_F5 = 294, W_F6 = 295, W_F7 = 296, W_F8 = 297, W_F9 = 298,
        W_F10 = 299, W_F11 = 300, W_F12 = 301, W_F13 = 302, W_F14 = 303,
        W_F15 = 304, W_F16 = 305, W_F17 = 306, W_F18 = 307, W_F19 = 308,
        W_F20 = 309, W_F21 = 310, W_F22 = 311, W_F23 = 312, W_F24 = 313,
        W_F25 = 314, W_KP_0 = 320, W_KP_1 = 321, W_KP_2 = 322, W_KP_3 = 323,
        W_KP_4 = 324, W_KP_5 = 325, W_KP_6 = 326, W_KP_7 = 327, W_KP_8 = 328,
        W_KP_9 = 329, W_KP_DECIMAL = 330, W_KP_DIVIDE = 331,
        W_KP_MULTIPLY = 332, W_KP_SUBTRACT = 333, W_KP_ADD = 334,
        W_KP_ENTER = 335, W_KP_EQUAL = 336, W_LEFT_SHIFT = 340,
        W_LEFT_CONTROL = 341, W_LEFT_ALT = 342, W_LEFT_SUPER = 343,
        W_RIGHT_SHIFT = 344, W_RIGHT_CONTROL = 345, W_RIGHT_ALT = 346,
        W_RIGHT_SUPER = 347, W_MENU = 348, W_LMB = 350, W_RMB = 351,
        W_MMB = 352, W_MB_4 = 353, W_MB_5 = 354, W_MB_6 = 355, W_MB_7 = 356,
        W_MB_8 = 357
    };
	class Window
	{

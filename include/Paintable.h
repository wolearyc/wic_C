...
namespace wick
{
    ...
    /// be painted around), and a geometric center that is defined by
    /// subclasses. The center and geometric centers are not relative to the
    /// screen, but relative to the object they are defined in. Any rotation and
    /// scaling /// (defined in Rotateable and Scaleable respectively) is done
    /// around the center defined in Paintable.
    class Paintable
    {
    public:
        /// \brief A constructor
        ...
        /// \brief Retrieves whether or not the Paintable object is to be
        ///        painted around the center
        /// \return whether or not the object is to be painted around the center
        bool isPaintedCentered();
        /// \brief Modifies whether or not the Paintable object is to be painted
        ///        around the center
        /// \param paintCentered whether or not the object should be painted
        ///        around the center
        void paintCentered(bool paintCentered);
        /// \brief Returns the geometric center of the object.
        ///
        /// Keep in mind that the geometric center should be defined in
        /// subclasses. If it is not defined, the geometric center will always
        /// be (0,0), which is wrong is nearly all cases.

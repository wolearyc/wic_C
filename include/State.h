...
namespace wick
{
    ...
    /** \brief a game state that can be initialized, updated, and painted.
      ...
      * subclasses of State. These programmer-defined States must define a 
      * destructor, initialize method, update method, and paint method.
      */
    class State
    {
    public:
        /** \brief constructs State
          */
        State();
        /** \brief deallocates State
          *
          * The destructor should deallocate all pointers, like Textures and
          * Fonts, and change the values of the pointers to nullptr.
          */
        virtual ~State();
        /** \brief initializes the State
          *
          * This method is called once before the State is updated and painted
          * repeatedly. Typically, objects are constructed here.
          */
        virtual void initialize(Game* game) = 0;
        /** \brief updates the State
          *
          * Each time before paint is called, this method is called once.
        ...
        /** \brief Paints the State to the screen
          *
          * This method is called once for every frame, so typically about

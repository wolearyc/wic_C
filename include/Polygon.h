...
namespace wick
{
    ...
    {
    public:
        /** \brief constructs Polgon based on a vector of vertices
        ...
        /** \brief constructs Polygon based on an initializer_list of vertices
          *
        ...
        Polygon(Pair location, initializer_list<Pair> baseVertices,
                Color color);
        /** \brief constructs Polygon as a white square of dimensions 32x32 at
          *        location (0,0)
          */
        Polygon();
        /** \brief constructs a Polygon identical to another
          * \param other another Polygon
          */
        Polygon(const Polygon& other);
        /** \brief paints Polygon to the screen
          * \param game the game
          */
